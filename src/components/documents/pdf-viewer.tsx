...
// Configure PDF.js worker — bundled locally to avoid external CDN dependency
// If pdfjs-dist is updated, re-copy: cp node_modules/pdfjs-dist/build/pdf.worker.min.mjs public/pdf.worker.min.mjs
